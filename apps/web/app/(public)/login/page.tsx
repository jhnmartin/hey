  ...
  if (needsMfa) {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col items-center justify-center px-4">
        ...
        <form onSubmit={onMfaVerify} className="mt-8 w-full space-y-4">
    ...
    <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col items-center justify-center px-4">
      ...
      <form onSubmit={onSubmit} className="mt-8 w-full space-y-4">
        ...
        <div className="flex justify-end">
          <Link href="/forgot-password" className="text-muted-foreground hover:text-foreground text-sm">
            Forgot password?
          </Link>
        </div>
        <button
